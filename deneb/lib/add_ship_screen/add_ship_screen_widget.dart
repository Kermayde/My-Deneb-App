...
class AddShipScreenWidget extends StatefulWidget {
  const AddShipScreenWidget({Key? key}) : super(key: key);

  @override
  _AddShipScreenWidgetState createState() => _AddShipScreenWidgetState();
}

class _AddShipScreenWidgetState extends State<AddShipScreenWidget>
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            final starshipsCreateData =
                              ...
                              speedLY: typeCIntTController!.text,
                              passengers: natureCIntTController!.text,
                            );
